...
class BoldItalicInlineRenderer extends InlineRenderer {
  const BoldItalicInlineRenderer();

  @override
  String get type => NodeType.boldItalic;

  @override
  InlineSpan build(RenderContext ctx, Map<String, dynamic> node, TextStyle style) {
    final next = style.merge(ctx.theme.boldItalicTextStyle);
    return TextSpan(
      style: next,
